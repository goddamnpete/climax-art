...
$page = (int)$page;
include("common.php");
function checkUsr ($db, $char1, $char2, $page, $assist1, $assist2, $grade1, $grade2, $player1, $player2, $winner, $nwinner, $locale, $vers, $end) {
	$start = $page*25;
	$end = ($page+1)*25;
	$exe = "SELECT DISTINCT * FROM matches WHERE ((
		 ...
		 OR (
			...
			AND winner LIKE :w2))
		AND locale LIKE :loc AND version LIKE :vers
...
$res = checkUsr($db, $char1, $char2, $page, $assist1, $assist2, $grade1, $grade2, $player1, $player2, $winner, $nwinner, $locale, $vers, $end);
